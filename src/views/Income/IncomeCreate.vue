<template>
	<div
		...
		tabindex="-1"
		aria-labelledby="incomeCreateModalLabel"
		aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="incomeCreateModalLabel">
						Income Create
					</h1>
					<button
						type="button"
				...
				<template v-if="!loading">
					<div class="modal-body">
						<form @submit.prevent>
							...
							<div class="mb-3">
								<label for="incomeAccount" class="form-label"
									>Income Account</label
								>
								<VueMultiselect
									:model-value="selectedIncomeAccount"
									@update:model-value="updateSelectedIncomeAccount"
									...
									:option-height="31"
									track-by="_id"
									:custom-label="customIncomeAccountListLabel"
